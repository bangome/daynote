...
internal static class KoreanStrings
{
    internal static IReadOnlyDictionary<string, string> Values { get; } = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["TutorialTagsBody"] = "제목 아래 '+ 태그'에 단어를 적으면 노트에 태그가 붙습니다. 오른쪽 '태그' 탭에서 태그별로 노트를 모아 보고, 태그를 누르면 그 노트로 이동합니다.",
        ...
        ["SaveFileTitle"] = "다른 이름으로 저장",
        ["SaveFileFilter"] = "{0} 파일|*{1}|모든 파일|*.*",
        ["SaveFileFilterAny"] = "모든 파일|*.*",
        ["SaveFileTip"] = "두 번 클릭하면 파일로 저장합니다",
        ["SaveFileDoneFormat"] = "저장됨 · {0}",
        ["SaveFileFailed"] = "저장하지 못했습니다",
        ["DeleteNoteTip"] = "노트 삭제",
        ["NoteMenuRename"] = "이름 변경",
        ["NoteMenuDuplicate"] = "복제",
        ["NoteMenuDelete"] = "삭제",
        ["NoteDuplicateSuffix"] = " (복사)",
        ...
        ["CloudSyncLocalNote"] = "이 PC의 데이터베이스는 계속 평문이며, 동기화는 백업을 대신하지 않습니다. 지금 동기화되는 것은 노트·할 일·태그·즐겨찾기이고, 이미지·파일 동기화는 준비 중입니다.",
        ...
        ["BillingTrialOver"] = "체험 기간이 끝났습니다. 노트는 계속 동기화되고, 구독하면 이미지·파일 동기화가 다시 시작됩니다.",
        ["BillingExpired"] = "구독이 만료되어 이미지·파일 동기화가 멈췄습니다. 노트는 계속 동기화되고, 클라우드에 올린 파일도 그대로 보관되어 있습니다.",
        ...
        ["BillingExpiredBannerTitle"] = "이미지·파일 동기화가 멈췄습니다",
