...
public sealed class MacGlobalHotkeyService : IGlobalHotkeyService
{
    ...
    internal static class KeyCodes
    {
        private static readonly Dictionary<HotkeyKey, uint> Map = new()
        {
            ...
            [HotkeyKey.D6] = 0x16,
            [HotkeyKey.D5] = 0x17,
            [HotkeyKey.OemPlus] = 0x18,
            [HotkeyKey.D9] = 0x19,
            [HotkeyKey.D7] = 0x1A,
            [HotkeyKey.OemMinus] = 0x1B,
            [HotkeyKey.D8] = 0x1C,
            [HotkeyKey.D0] = 0x1D,
            [HotkeyKey.OemCloseBrackets] = 0x1E,
            [HotkeyKey.O] = 0x1F,
            [HotkeyKey.U] = 0x20,
            [HotkeyKey.OemOpenBrackets] = 0x21,
            [HotkeyKey.I] = 0x22,
            [HotkeyKey.P] = 0x23,
            [HotkeyKey.Return] = 0x24,
            [HotkeyKey.L] = 0x25,
            [HotkeyKey.J] = 0x26,
            [HotkeyKey.OemQuotes] = 0x27,
            [HotkeyKey.K] = 0x28,
            [HotkeyKey.OemSemicolon] = 0x29,
            [HotkeyKey.OemBackslash] = 0x2A,
            [HotkeyKey.OemComma] = 0x2B,
            [HotkeyKey.OemQuestion] = 0x2C,
            [HotkeyKey.N] = 0x2D,
            [HotkeyKey.M] = 0x2E,
            [HotkeyKey.OemPeriod] = 0x2F,
            [HotkeyKey.Tab] = 0x30,
