...
internal static class EnglishStrings
{
    internal static IReadOnlyDictionary<string, string> Values { get; } = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["SaveFileTitle"] = "Save a copy",
        ["SaveFileFilter"] = "{0} file|*{1}|All files|*.*",
        ["SaveFileFilterAny"] = "All files|*.*",
        ["SaveFileTip"] = "Double-click to save a copy",
        ["SaveFileDoneFormat"] = "Saved · {0}",
        ...
        ["CloudSyncLocalNote"] = "The database on this PC stays unencrypted, and sync is not a substitute for a backup. What syncs today is notes, to-dos, tags and favorites; image and file sync is still being built.",
        ...
        ["BillingTrialOver"] = "Your trial has ended. Notes keep syncing; subscribe to sync images and files again.",
        ["BillingExpired"] = "Your subscription ended, so image and file sync has stopped. Notes keep syncing, and the files you already uploaded are kept.",
        ...
        ["BillingExpiredBannerTitle"] = "Image and file sync has stopped",
